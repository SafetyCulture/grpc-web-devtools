...
func (c *exampleServiceClient) AlwaysError(ctx context.Context, in *ExampleOneRequest, opts ...grpc.CallOption) (*ExampleOneResponse, error) {
	out := new(ExampleOneResponse)
	err := grpc.Invoke(ctx, "/s12.example.ExampleService/AlwaysError", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var fileDescriptor0 = []byte{
	...
	0xa6, 0x8f, 0x09, 0xae, 0xcf, 0xe8, 0x1f, 0x23, 0x17, 0x1f, 0x54, 0x63, 0x70, 0x6a, 0x51, 0x59,
	...
	0x52, 0x9e, 0x8f, 0xd7, 0x38, 0xb0, 0x3c, 0xd4, 0x38, 0x3f, 0x2e, 0x6e, 0xc7, 0x9c, 0xf2, 0xc4,
	0xca, 0x62, 0xd7, 0xa2, 0xa2, 0xfc, 0x22, 0x8a, 0x9d, 0xe7, 0xc4, 0x16, 0xc5, 0x92, 0x9b, 0x98,
	0x99, 0x97, 0xc4, 0x06, 0x0e, 0x6e, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x4b, 0x4a, 0x75,
	0xda, 0x9c, 0x01, 0x00, 0x00,
}
