...
proto.s12.example.ExampleServicePromiseClient =
  ...
  /**
   * @private @const {!proto.s12.example.ExampleServiceClient} The delegate callback based client
   */
  this.delegateClient_ = new proto.s12.example.ExampleServiceClient(
...
proto.s12.example.ExampleServicePromiseClient.prototype.exampleOne =
  ...
  return new Promise(function (resolve, reject) {
    _this.delegateClient_.exampleOne(
...
proto.s12.example.ExampleServicePromiseClient.prototype.exampleTwo =
  ...
  var _this = this;
  return new Promise(function (resolve, reject) {
    _this.delegateClient_.exampleTwo(
      request, metadata, function (error, response) {
        error ? reject(error) : resolve(response);
      });
  });
